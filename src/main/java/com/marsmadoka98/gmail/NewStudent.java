...
public class NewStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(25, 63, 56), 2, true), "NEW STUDENT", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 18), new java.awt.Color(213, 17, 17))); // NOI18N

        jLabel1.setText("Student ID/RegNO");
    ...
    private void jButton1registerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1registerActionPerformed
         String sql="insert into Student(Student_ID,Name,ID_Number,course,branch,year,semester) values(?,?,?,?,?,?,?)"; //book is the table name
